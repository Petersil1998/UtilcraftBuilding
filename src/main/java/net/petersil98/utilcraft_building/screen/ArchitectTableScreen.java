...
//TODO: Fix resizing
public class ArchitectTableScreen extends AbstractContainerScreen<ArchitectTableContainer> {
    ...
    public ArchitectTableScreen(ArchitectTableContainer screenContainer, Inventory inv, Component title) {
    ...
    protected void renderBg(@Nonnull PoseStack matrixStack, float partialTicks, int x, int y) {
        ...
        RenderSystem.setShaderTexture(0, ARCHITECT_TABLE_GUI_TEXTURES);
        int i = this.leftPos;
        int j = (this.height - this.imageHeight) / 2;
        this.blit(matrixStack, i, j, 0, 0, this.imageWidth, this.imageHeight);
        GuiComponent.blit(matrixStack, i, j, this.getBlitOffset(), 0,0, this.imageWidth, this.imageHeight, 512, 512);
    }
    ...
    protected void renderLabels(@Nonnull PoseStack matrixStack, int x, int y) {
        ...
        this.addRenderableWidget(this.removeLayerButton);
    }
