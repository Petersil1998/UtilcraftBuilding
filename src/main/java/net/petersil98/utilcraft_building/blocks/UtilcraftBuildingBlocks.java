...
public class UtilcraftBuildingBlocks {
    ...
    public static final RegistryObject<BlueprintBlock> BLUEPRINT_BLOCK = BLOCKS.register("blueprint_block", () -> new BlueprintBlock(Block.Properties.of(Material.STONE).noDrops().noCollission().instabreak()));
